<div class="profile-card">
            	<img src="images/users/user-4.jpg" alt="user" class="profile-photo" />
            	<h5><a href="timeline.html" class="text-white">Jhon Doe</a></h5>
...
<div class="suggestions" id="sticky-sidebar">
              ...
              <div class="follow-user">
                ...
                <div>
                  ...
                  <a href="#" class="text-black">Add friend</a>
                </div>
              </div>
              <div class="follow-user">
